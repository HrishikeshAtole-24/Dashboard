        ...
        {loadingData ? (
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {websites.map((website) => (
              <div key={website.id} className="card website-card">
                <div className="website-card-header">
                  <div className="website-info">
                    <h3 className="website-title">{website.name}</h3>
                    <p className="website-domain">{website.domain}</p>
                  </div>
                ...
                <div className="website-tracking">
                  ...
                  <code className="tracking-id">{website.website_id}</code>
                </div>

                <div className="website-footer">
                  <span className={`status-badge ${website.is_active ? 'status-active' : 'status-inactive'}`}>
                    {website.is_active ? 'Active' : 'Inactive'}
                  </span>
                  
                  <button
                    onClick={() => copyTrackingCode(website.website_id, website.domain)}
                    className={`copy-code-btn ${copiedTrackingId === website.website_id ? 'copied' : ''}`}
                  >
